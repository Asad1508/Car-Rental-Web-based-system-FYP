...
<body>
    ...
    <div class="last">
    <h5 style="color: white; margin-left: 1100px; font-family: Consolas, 'Andale Mono', 'Lucida Console', 'Lucida Sans Typewriter', Monaco, 'Courier New', 'monospace'; font-size: 20px;">Connect with Us </h5>    
