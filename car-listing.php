...
<!--isme jo link ha vehicle detail page ka jab uss pr jye ga tu vhid b sath lekr jye ga k kis car pr click kia uski 
detail lekr jye ga id se ($result ->id) show kraye ga -->
              <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn">View <span class="angle_arrow"><i class="fa fa-eye" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> find car by search </h5>
          </div>
